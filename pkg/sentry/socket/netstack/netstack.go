...
var Metrics = tcpip.Stats{
	...
	IP: tcpip.IPStats{
		...
		IPTablesPreroutingDropped:           mustCreateMetric("/netstack/ip/iptables_prerouting_dropped", "Total number of IP packets dropped in the Prerouting chain."),
		IPTablesInputDropped:                mustCreateMetric("/netstack/ip/iptables_input_dropped", "Total number of IP packets dropped in the Input chain."),
		IPTablesOutputDropped:               mustCreateMetric("/netstack/ip/iptables_output_dropped", "Total number of IP packets dropped in the Output chain."),
	},
	TCP: tcpip.TCPStats{
