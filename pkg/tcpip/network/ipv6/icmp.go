...
// sendICMPError sends an ICMP error report back to the remote device that
// sent the problematic packet. It will incorporate as much of that packet
...
// per RFC 4443.
func sendICMPError(r *stack.Route, eType header.ICMPv6Type, eCode header.ICMPv6Code, aux uint32, pkt *stack.PacketBuffer) *tcpip.Error {
